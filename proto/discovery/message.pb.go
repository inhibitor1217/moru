...
type Announcement struct {
	...
	Username      *string                `protobuf:"bytes,2,opt,name=username,proto3,oneof" json:"username,omitempty"` // Username of the peer.
	Hostname      *string                `protobuf:"bytes,3,opt,name=hostname,proto3,oneof" json:"hostname,omitempty"` // Hostname of the peer.
	Role          string                 `protobuf:"bytes,4,opt,name=role,proto3" json:"role,omitempty"`               // Role of the peer (host, peer)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Announcement) GetHostname() string {
...
func (x *Announcement) GetRole() string {
	if x != nil {
		return x.Role
	}
	return ""
...
var file_discovery_message_proto_rawDesc = string([]byte{
	...
	0x03, 0x10, 0x0a, 0x22, 0x98, 0x01, 0x0a, 0x0c, 0x41, 0x6e, 0x6e, 0x6f, 0x75, 0x6e, 0x63, 0x65,
	...
	0x65, 0x42, 0x0b, 0x0a, 0x09, 0x5f, 0x68, 0x6f, 0x73, 0x74, 0x6e, 0x61, 0x6d, 0x65, 0x42, 0x2f,
	0x5a, 0x2d, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x69, 0x6e, 0x68,
	0x69, 0x62, 0x69, 0x74, 0x6f, 0x72, 0x31, 0x32, 0x31, 0x37, 0x2f, 0x6d, 0x6f, 0x72, 0x75, 0x2f,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x64, 0x69, 0x73, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x79, 0x62,
...
func file_discovery_message_proto_init() {
	...
	file_discovery_message_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
